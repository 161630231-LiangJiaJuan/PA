...
make_group(gp4,
  ...
  /* 0xff */
make_group(gp5,
    IDEX(E,inc), IDEX(E,dec),EX(call_rm) , IDEX(E,call),
    IDEX(E,jmp), IDEX(E,jmp), EX(push), EMPTY)
...
opcode_entry opcode_table [512] = {
  ...
  /* 0x08 */	EMPTY, IDEX(E2G,or), IDEXW(E2G,or,1),IDEX(E2G,or),
  ...
  /* 0x7c */	IDEXW(J,jcc,1), IDEXW(J,jcc,2), IDEXW(J,jcc,1), IDEXW(J,jcc,1),
  ...
  /* 0xe8 */	IDEXW(I,call,4), EMPTY, EMPTY, IDEXW(J,jmp,1),
  ...
  /* 0x84 */	IDEXW(G2E,test,1), IDEX(J,jcc), EMPTY, IDEX(J,jcc),
